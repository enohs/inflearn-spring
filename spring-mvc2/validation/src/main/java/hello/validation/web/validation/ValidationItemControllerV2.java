...
public class ValidationItemControllerV2 {
  ...
  // 현재 컨트롤러 내부에 있는 메서드 중 @Validated가 붙은 객체를 가진 컨트롤러가 동작할 때마다 검증해줌
  @InitBinder
  ...
  public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
    // BindingResult는 @ModelAttribute로 Model에 들어가는 파라미터 바로 뒤에 위치해야 한다
    // bindingResult가 이전의 에러 보관소 역할을 하고, Model 없이도 뷰로 보내준다
  ...
  // 잘못된 값 넣어도 브라우저에서 값이 유지되도록 FieldError 파라미터 활용
  //@PostMapping("/add")
