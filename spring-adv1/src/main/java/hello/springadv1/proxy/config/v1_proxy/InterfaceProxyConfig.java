...
import hello.springadv1.proxy.config.v1_proxy.interface_proxy.OrderControllerInterfaceProxy;
import hello.springadv1.proxy.config.v1_proxy.interface_proxy.OrderRepositoryInterfaceProxy;
import hello.springadv1.proxy.config.v1_proxy.interface_proxy.OrderServiceInterfaceProxy;
